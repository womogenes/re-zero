...
GLM-4.7-Flash (30B MoE, 3B active) with 4x H100.
"""
...
def main(config: str = "glm4flash-redteam.toml", resume: bool = False):
    ...
    Examples:
        modal run deploy/train.py --config glm4flash-redteam.toml
        modal run deploy/train.py --config glm4flash-codevuln.toml --resume
    """
