"""Modal deployment for Nemotron 3 Nano (30B-A3B) via vLLM.

Serves either the base HF model or an RL-trained checkpoint from the checkpoints volume.
Set CHECKPOINT to a path like "nemotron-nano-redteam-attack/step-200" to serve a trained model.
"""
...
# e.g. "nemotron-nano-redteam-attack/step-200"
CHECKPOINT = None
...
app = modal.App("re-zero-nemotron-nano")
